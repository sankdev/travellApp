...
const ClassComponent = () => {
    ...
    const [formData, setFormData] = useState({ name: '', status: 'active', priceMultiplier: '' });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editMode) {
                await classeService.updateClasse(editId, formData);
            ...
            setFormData({ name: '', status: 'active', priceMultiplier: '' });
            setEditMode(false);
            setEditId(null);
            fetchClasses();
        } catch (err) {
    ...
    const handleEdit = (classItem) => {
        setFormData({ name: classItem.name, status: classItem.status,  priceMultiplier: classItem.priceMultiplier });
        setEditMode(true);
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-2xl font-bold mb-4 text-orange-800">Manage Classes</h1>
            ...
            <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg p-6 mb-8">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className={`w-md mt-4 px-4 py-2 text-white font-semibold bg-orange-600 rounded-md shadow-md transition
 duration-200 ease-in-out transform hover:scale-105 hover:bg-orange-700 focus:ring-2 focus:ring-offset-2 focus:ring-orange-400 ${
            ...
            <div className="bg-white shadow rounded-lg p-6">
                <h2 className="text-xl font-semibold mb-4 text-orange-800">Class List</h2>
