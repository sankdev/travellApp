   ...
   const handleSubmit = async (e) => {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-2xl font-bold mb-4 text-orange-800">Gestion Destinations</h1>
            ...
            <div className="bg-white shadow rounded-lg p-6">
                <h2 className="text-xl font-semibold mb-4 text-orange-800">Destination List</h2>
