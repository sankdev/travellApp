...
//console.log('agencies',agencies.data)
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-2xl font-bold mb-4 text-orange-800">Manage Vols</h1>
 ...
 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 ${
            ...
            <div className="bg-white shadow rounded-lg p-6">
                <h2 className="text-xl font-semibold mb-4 text-orange-700">Vol List</h2>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {vols?.map((vol) => (
                                <tr key={vol.id}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">{vol.companyVol.name}</td>
