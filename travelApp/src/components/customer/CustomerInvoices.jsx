...
const CustomerInvoices = () => {
    ...
    const fetchInvoices = async () => {
        try {
            ...
            const response = await invoiceService.getInvoicesForCustomer();
            console.log('invoicesListes',response)
                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {loading ? (
                                <tr>
                                    <td colSpan="6" className="text-center py-6 text-gray-500">Chargement des factures...</td>
                                </tr>
                            ) : (
                                filteredInvoices.map((invoice) => (
                                    <tr key={invoice.id}>
                                        ...
                                        <td className="px-6 py-4 text-sm text-gray-500">
                                            {invoice.reservation?.startDestination?.city || 'N/A'} → {invoice.reservation?.endDestination?.city || 'N/A'}
                                        </td>
