...
const InvoiceDetails = () => {
    ...
    const fetchInvoiceDetails = async () => {
        try {
            ...
            console.log('📄 Détails facture:', response.data.data);
    ...
    const handleSendEmail = () => {
        ...
        alert('Fonctionnalité d\'envoi par email à venir');
    };

    const handlePay = () => {
        if (invoice.balance > 0) {
            navigate(`/customer/invoices/${invoiceId}/pay`);
        }
    };
    ...
    return (
        <div className="max-w-6xl mx-auto p-4 sm:p-6">
            ...
            <div className="bg-gradient-to-r from-orange-600 to-indigo-600 rounded-t-xl p-4 sm:p-6 text-white">
            ...
            <div className="bg-white rounded-b-xl shadow-lg p-4 sm:p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg">
                                ...
                                <p className="font-medium text-gray-900">
                                 ...
                                 <p className="font-medium text-gray-900">
                                   Tél: {reservation?.agencyReservations?.phone1 || 'N/A'}
                                </p>
                                  <p className="font-medium text-gray-900">
                                    {reservation?.agencyReservations?.address || 'N/A'}
                                </p>
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg md:col-span-2">
                                <h3 className="text-sm font-semibold text-gray-700 mb-3">Résumé financier</h3>
                    ...
                    {activeTab === 'payments' && (
                        <div className="space-y-4">
                            <h3 className="text-lg font-semibold text-gray-800 flex items-center">
                                <FontAwesomeIcon icon={faMoneyBill} className="text-green-500 mr-2" />
                            ...
                            {payments.length > 0 ? (
                                <div className="space-y-3">
                                    {payments.map((payment, index) => (
                                        <div key={index} className="bg-gray-50 p-4 rounded-lg flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                                            <div>
                                                <p className="font-medium text-gray-900">
                                                    {formatDateTime(payment.paymentDate)}
                                                </p>
                                                <p className="text-sm text-gray-500">
                                                    Mode: {payment.paymentMode?.name || 'Non spécifié'}
                                                </p>
                                            </div>
                            ...
                            {balance > 0 && (
                                <div className="mt-6 text-center">
                                    ...
                                    >
                                        ...
                                        Payer le solde de {formatCurrency(balance)}
                                    </button>
                                </div>
                            )}
                        </div>
                ...
                <div className="mt-8 pt-6 border-t text-center text-sm text-gray-500">
                    ...
                    <p className="mt-1">Pour toute question, contactez notre service client</p>
                </div>
            </div>
        </div>
    );
