...
const CustomerProfile = () => {
    ...
    const fetchProfile = async () => {
        try {
            ...
            setProfile(data);
            setProfileId(data.id); // Store profileId in the state
            setFormData(data);
    ...
    const handleEdit = async (profileId) => {
        ...
        try {
          const response = await customerService.getCustomerProfileById(profileId);
    ...
    return (
        ...
        <div className="md:col-span-1">
                <div className="px-4 sm:px-0">
                    <h3 className="text-lg font-semibold text-gray-900">Create a New Customer</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="text-center">
                        {!isEditing ? (
                            <button
  onClick={() => {
    handleEdit(profileId); // Pass the correct profile ID
    setIsEditing(true);
  }}
  className="inline-flex items-center gap-2 py-2 px-5 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
>
  Edit Profile
</button>
