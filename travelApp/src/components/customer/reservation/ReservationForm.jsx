...
const SimpleReservationRequest = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    startDestinationId: '',
    endDestinationId: '',
    startAt: '', // ✅ Date de départ
    endAt: '',   // ✅ Date de retour (pour aller-retour)
    tripType: 'one-way',
    description: '',
    totalPrice: 0
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const reservationData = {
        ...
        startAt: formData.startAt, // ✅ Date de départ
        endAt: formData.tripType === 'round-trip' ? formData.endAt : null, // ✅ Date de retour
        tripType: formData.tripType, // ✅ Type de voyage
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-white rounded-lg shadow p-4">
            <h2 className="text-md font-semibold text-gray-700 mb-3 flex items-center gap-2">
              ...
              3. Dates de voyage <span className="text-xs text-red-500 ml-2">* obligatoire</span>
            </h2>
          ...
          {includeFlight && (
            <div className="bg-white rounded-lg shadow p-4">
              <h2 className="text-md font-semibold text-gray-700 mb-3 flex items-center gap-2">
                ...
                4. Vol aller <span className="text-xs text-gray-500 ml-2">(optionnel)</span>
              </h2>
          ...
          {includeFlight && selectedOutboundFlight && (
            <div className="bg-white rounded-lg shadow p-4">
              <h2 className="text-md font-semibold text-gray-700 mb-3 flex items-center gap-2">
                ...
                5. Sélection de la classe <span className="text-xs text-gray-500 ml-2">(optionnel)</span>
              </h2>
