   ...
   const fetchDestinations = async () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-2xl font-bold mb-4 text-center text-gray-800"> Reservations Listes </h1>
    ...
    {/* Afficher le bouton "Accept Demand" uniquement pour le statut "counter-proposal" */}
...
export default ReservationListes;
