...
const ManualFlightSelection = ({
  ...
  // Charger toutes les classes disponibles au chargement du composant
  useEffect(() => {
    const fetchAllClasses = async () => {
      ...
      try {
        ...
        if (response && Array.isArray(response)) {
          // Enrichir les données des classes
  ...
  return (
    <div className="space-y-6 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border-2 border-green-200">
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Prix: {vol.price.toLocaleString()} FCFA
                    </p>
                  </div>
                </div>
              </li>
      ...
      {/* Section Classe - Liste déroulante pour choisir la classe */}
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">
                                    ...
                                    >
                                        ...
                                        {campaigns.map(campaign => (
                                            <option key={campaign.id} value={campaign.id}>
                                                {campaign.title} - {campaign.price.toLocaleString()} FCFA/pers
