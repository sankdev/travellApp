    ...
    const handleCampaignChange = async (campaignId) => {
        ...
        try {
            ...
            // CAS 2: La campagne n'a PAS de vol défini
                ...
                console.log('ℹ️ Campagne SANS vol - champs optionnels');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const payload = {
                ...
                // Indiquer si le vol vient de la campagne ou non
                        ...
                        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg overflow-hidden">
                            ...
                            <div className="p-6 border-b border-gray-200">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {/* Vol - Conditionnel selon la campagne */}
                                    {campaignHasFlight ? (
                                        // CAS 1: Campagne avec vol - Affichage automatique
                                        <div className="space-y-4">
                                        ...
                                        // CAS 2: Campagne sans vol - Champs optionnels
                                        <div className="space-y-4">
                                            <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                                                <p className="text-sm text-yellow-700 flex items-center gap-2">
                                                    <FontAwesomeIcon icon={faInfoCircle} />
                                                    Cette campagne ne définit pas de vol. Vous pouvez en sélectionner un ci-dessous.
                                                </p>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                {showVolSuggestions && vols.length > 0 && (
                                                    <ul className="absolute z-20 w-full lg:w-[calc(66.666%-2rem)] mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                                                        {vols.map((vol) => (
                                                            <li
                                                                key={vol.id}
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div className="relative">
                                                    ...
                                                    {showStartDestinationSuggestions && startDestinations.length > 0 && (
                                                        <ul className="absolute z-20 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-40 overflow-y-auto">
                                                            {startDestinations.map((dest) => (
                                                                <li
                                                                    ...
                                                                    onClick={() => {
                                                                        ...
                                                                        setFormData(prev => ({ ...prev, startDestinationId: dest.id }));
                                                                        setShowStartDestinationSuggestions(false);
                                                                    }}
                                                                >
                                                                    {dest.name}
                                                            ...
                                                            {endDestinations.map((dest) => (
                                                                <li
                                                                    ...
                                                                    onClick={() => {
                                                                        ...
                                                                        setFormData(prev => ({ ...prev, endDestinationId: dest.id }));
                                                                        setShowEndDestinationSuggestions(false);
                                                                    }}
                                                                >
                                                                    {dest.name}
                                    ...
                                    <div key={index} className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                                        ...
                                        <div className="mt-4">
                                            ...
                                            {passenger.document.map((doc, docIndex) => (
                                                <div key={docIndex} className="mt-3 p-3 bg-white rounded border">
                            ...
                            <div className="space-y-4">
                                ...
                                {selectedCampaign && (
                                    <div className="p-3 bg-blue-50 rounded-lg">
                                        ...
                                        <div className="space-y-1 text-xs text-blue-600">
                                            <p>• {campaignHasFlight ? 'Vol inclus' : 'Vol optionnel'}</p>
                                ...
                                <div className="mt-4 text-xs text-gray-500 space-y-1">
                                    ...
                                    <p className="flex items-center gap-1">
                                        <FontAwesomeIcon icon={faInfoCircle} className="text-blue-400" />
                                        {campaignHasFlight 
                                            ? 'Le vol est automatiquement sélectionné par la campagne'
