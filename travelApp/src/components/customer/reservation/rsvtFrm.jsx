...
const ReservationForm = () => {
  ...
  // États pour la compagnie (caché par défaut)
  ...
  // Gestion des classes disponibles pour le vol sélectionné
  useEffect(() => {
    if (selectedVol) {
  ...
  // Gestion de la compagnie (section cachée par défaut)
  ...
  // ============================================
  // GESTION DE LA SÉLECTION DE CLASSE AVEC LISTE DÉROULANTE
  // ============================================
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 mt-1">
              <span className="text-xs px-2 py-0.5 bg-purple-100 text-purple-800 rounded-full">
                {classAgency.availableSeats || 'N/A'} sièges
              </span>
              {isSelected && (
  ...
  return (
    <div className="container mx-auto p-4 max-w-6xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        {/* Section Compagnie (Cachée par défaut) */}
        <div className="bg-white shadow rounded-lg p-6">
          <div 
        ...
        {/* Section Classe - AVEC LISTE DÉROULANTE */}
        <div className="bg-white shadow rounded-lg p-6">
          <h2 className="text-lg font-medium text-gray-800 mb-4 flex items-center">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 mt-2">
                    ...
                    {selectedClassAgency.availableSeats && (
                      <span className="text-xs px-2 py-1 bg-blue-100 text-blue-800 rounded-full">
                        {selectedClassAgency.availableSeats} sièges disponibles
                      </span>
                    )}
                  </div>
