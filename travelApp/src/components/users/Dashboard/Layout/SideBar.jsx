...
const Sidebar = ({ isMobile, isOpen, toggleSidebar }) => {
  const navItems = [
    ...
    { name: 'UserAgency', path: '/admin/user-agency', icon: faUsers },
    ...
    { name: 'Vols', path: '/admin/vol', icon: faKey },
    { name: 'Company', path: '/admin/company', icon: faKey },
    { name: 'Class', path: '/admin/class', icon: faKey },
    { name: 'Destinations', path: '/admin/destination', icon: faKey },
