...
const UserLogin = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-white bg-opacity-100 flex items-center justify-center p-4 z-50">
      <div className={`bg-white rounded-xl shadow-xl w-full max-w-2xl  ${hasPendingReservation ? 'max-w-4xl' : 'max-w-md'}`}>
        {/* Header */}
        ...
        <div className="flex flex-col md:flex-row">
          ...
          {/* Panel d'informations sur la réservation - MODIFIÉ EN ORANGE */}
          {hasPendingReservation && pendingFlightInfo && (
            <div className="md:w-1/2 bg-gradient-to-br from-orange-500 to-amber-500 border-l border-orange-400 p-6">
              <div className="h-full flex flex-col">
                <div className="mb-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <div>
                      <h3 className="font-bold text-white">Votre vol vous attend</h3>
                      <p className="text-sm text-orange-100">Connectez-vous pour réserver</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-3 bg-white/10 rounded-lg border border-white/20">
                      <div className="text-xs text-orange-100 mb-1">VOL</div>
                      <div className="font-semibold text-white">{pendingFlightInfo.flightName}</div>
                    </div>
                    
                    {/* Agence et Compagnie */}
                    <div className="grid grid-cols-2 gap-3">
                      <div className="p-3 bg-white/10 rounded-lg border border-white/20">
                        <div className="text-xs text-orange-100 mb-1">AGENCE</div>
                        <div className="font-medium text-white">{pendingFlightInfo.agencyName}</div>
                      </div>
                      
                      <div className="p-3 bg-white/10 rounded-lg border border-white/20">
                        <div className="text-xs text-orange-100 mb-1">COMPAGNIE</div>
                        <div className="font-medium text-white">{pendingFlightInfo.company}</div>
                      </div>
                    </div>
                    
                    {/* Trajet */}
                    <div className="p-3 bg-white/10 rounded-lg border border-white/20">
                      <div className="text-xs text-orange-100 mb-1">TRAJET</div>
                    ...
                    {/* Prix */}
                    <div className="p-3 bg-white/10 rounded-lg border border-white/20">
                      <div className="text-xs text-orange-100 mb-1">PRIX</div>
